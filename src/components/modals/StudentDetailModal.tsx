              ...
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white p-6 shadow-xl transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-1 text-sm text-gray-500">Student ID: {student.username}</div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <dl className="mt-2 space-y-2">
                      ...
                      <div>
                        ...
                        <dd>{new Intl.DateTimeFormat('en-US').format(new Date(student.birthday))}</dd>
                      </div>
                    ...
                    {student.parent ? (
                      <dl className="mt-2 space-y-2">
                        <div>
                          ...
                          <dd>{student.parent.name} {student.parent.surname}</dd>
                        </div>
                        <div>
                        ...
                        <div>
                          <dt className="text-gray-500">Address</dt>
                          <dd>{student.parent.address}</dd>
                        </div>
                      </dl>
                    ) : (
                      <p className="mt-2 text-gray-500">No parent information available</p>
                    )}
                  </div>
                </div>
